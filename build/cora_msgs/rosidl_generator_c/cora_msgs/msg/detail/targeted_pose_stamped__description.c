...
static char cora_msgs__msg__TargetedPoseStamped__FIELD_NAME__target_frame[] = "target_frame";
static char cora_msgs__msg__TargetedPoseStamped__FIELD_NAME__pose[] = "pose";

static rosidl_runtime_c__type_description__Field cora_msgs__msg__TargetedPoseStamped__FIELDS[] = {
  {
    {cora_msgs__msg__TargetedPoseStamped__FIELD_NAME__target_frame, 12, 12},
    {
  ...
  {
    {cora_msgs__msg__TargetedPoseStamped__FIELD_NAME__pose, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription cora_msgs__msg__TargetedPoseStamped__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {cora_msgs__msg__TargetedPoseStamped__FIELDS, 2, 2},
    },
    {cora_msgs__msg__TargetedPoseStamped__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  "string target_frame # name of Dummy link to select as frame.\n"
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *cora_msgs__msg__TargetedPoseStamped__get_individual_type_description_source(NULL),
